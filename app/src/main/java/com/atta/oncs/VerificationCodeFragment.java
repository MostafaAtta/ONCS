...
public class VerificationCodeFragment extends Fragment implements VerifyContract.View, View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        verifyPresenter.verifyMobile(mobileNumber, regionId);
    ...
    @Override
    public void onStop() {
        Objects.requireNonNull(getActivity()).unregisterReceiver(smsVerificationReceiver);
        super.onStop();
    }
